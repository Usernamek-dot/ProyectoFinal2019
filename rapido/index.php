   ...
   <header id="home">
      ...
      <div class="row banner">
         <div class="banner-text">
            <h1 class="responsive-headline">REMEMBER</h1>
            <h3>I'm a Manila based <span>graphic designer</span>, <span>illustrator</span> and <span>webdesigner</span> creating awesome and
            effective visual identities for companies of all sizes around the globe. Let's <a class="smoothscroll" href="#about">start scrolling</a>
            and learn more <a class="smoothscroll" href="#about">about me</a>.</h3>
            <hr />
            <ul class="social">
               <li><a href="../perras.php"><i class="fa fa-facebook"></i></a></li>
               <li><a href="../sesion.php"><i class="fa fa-twitter"></i></a></li>
   ...
   <section id="about">
      ...
      <div class="row">
         ...
         <div class="three columns">
            ...
            <img class="profile-pic"  src="images/hola.jpg" alt="" />
      ...
      <div class="row">
         ...
         <div class="twelve columns collapsed">
          <form action="index.php" method="post">
           <input type="number" name="generacion">
           <input type="submit" value="enviar">
          </form>
            <h1>Galeria -FRAY JULIO TOBON BETANCUR.</h1>
               ...
               <div >
                  <div class="item-wrap" >
                       ...
                       <td>  <?php 
                           ...
                           $directory="imagenes/$generacion";
                           $dirint=dir($directory);
                           while (($archivo=$dirint->read())!== false) {
                            echo '<img src="'.$directory."/".$archivo.'" style="width: 250px; height: 250px;">';
                              }
                           $dirint->close();
                        ?>
                       </td>
            ...
            <div class="ten columns flex-container">
               ...
               <div class="flexslider">
                  ...
                  <ul class="slides">
                     ...
                     <li>
                        <blockquote>
                           <p>REMEMBER, FRAY JULIO TOBON BETANCUR
                           </p>  
         ...
         <div class="row">
            ...
            <div class="eight columns">
               ...
               <!-- form -->
                  ...
                  <input type="number" name="generacion" placeholder="generacion">
                  <input type="submit" value="enviar" >
               </form>
